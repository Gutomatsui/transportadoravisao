    ...
    <div class="banner">
        <div id="carousel-padrao" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner slider">
                <!-- SLIDE 4 -->
                <div class="item">
                    <h1>A Transportadora Visão<br>oferece as melhores soluções,<br>com equipamentos especiais<br>para
                        cargas
                        excedentes.</h1>
                    <img src="{{URL::to('public/img/transparencia-banner.png')}}"
                        class="img-responsive transparencia-banner">
                    <img src="{{URL::to('public/img/banner-06.png')}}" class="img-responsive')}}" alt="Banner 4"
                        title="Banner 4">
                </div>
                <!-- /SLIDE 4 -->
                <!-- SLIDE 2 -->
                <div class="item active">
                    ...
                    <img src="{{URL::to('public/img/transparencia-banner.png')}}"
                        class="img-responsive transparencia-banner">
                    <img src="{{URL::to('public/img/banner-05.png')}}" class="img-responsive" alt="Banner 2"
                        title="Banner 2">
                </div>
                <!-- /SLIDE 2 -->
                <!-- SLIDE 3 -->
                <div class="item">
                    ...
                    <img src="{{URL::to('public/img/transparencia-banner.png')}}"
                        class="img-responsive transparencia-banner">
                    <img src="{{URL::to('public/img/banner-04.png')}}" class="img-responsive" alt="Banner 3"
                        title="Banner 3">
                </div>
                <!-- /SLIDE 3 -->
                <!-- SLIDE 1 -->
                <div class="item">
                    ...
                    <img src="{{URL::to('public/img/transparencia-banner.png')}}"
                        class="img-responsive transparencia-banner">
                    <img src="{{URL::to('public/img/banner-01.jpg')}}" class="img-responsive" alt="Banner 1"
                        title="Banner 1">
                </div>
                <!-- /SLIDE 1 -->
            </div>
        ...
        <div class="col-md-9 home-item">
            ...
            <div class="col-md-4 home-servicos-item">
                <a href="">
                    <div class="home-servicos-item-imagem">
                        <img class="mobile"
                            src="{{URL::to('public/img/servicos/mobile-transporte-de-produtos-perigosos.jpg')}}">
                    </div>
            ...
            <div class="col-md-4 home-servicos-item">
                <a href="">
                    <div class="home-servicos-item-imagem">
                        <img class="mobile"
                            src="{{URL::to('public/img/servicos/mobile-armazenagem-de-mercadorias.jpg')}}">
                    </div>
...
<div class="mapa">
    <div class="mapa-unidade-santos">
        ...
        <div class="mapouter">
            <div class="gmap_canvas"><iframe width="100%" height="330" id="gmap_canvas"
