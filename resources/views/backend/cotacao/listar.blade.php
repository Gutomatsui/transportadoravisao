            ...
            <table class="table table-vcenter table-striped">
                <div class="col-md-4">
                    <div class="input-group">
                        <form action="{{ route('orcamento.buscar') }}" method="POST">
                            @csrf
                ...
                <tbody>
                    @foreach ($cotacao as $list)
                        <tr>
                            <td class="text-center">{{ $list->cnpj_emitente }}</td>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-xs text-center">
                                    ...
                                    <a href="{{ URL::to('cotacao/emails/' . $list->id) }}" data-toggle="tooltip"
                                        title="Ver Emails" class="btn btn-alt btn-sm btn-info">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <h5 class="text-center"> <a id="orcamentolink" href="" class="" target="_blank"><i
                                        class="fa fa-print"></i> Imprimir Orçamento </a></h5>
