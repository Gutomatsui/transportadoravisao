                                ...
                                <div class="servicos-item">
                                    <a href="#" data-target="#transporte-excedentes" data-toggle="modal">
                                        ...
                                        <div class="servicos-item-imagem">
                                            <img src="{{URL::to('public/img/servicos/cargas-excedentes.jpg')}}">
                                            <img class="mobile" src="{{URL::to('public/img/servicos/cargas-excedentes.jpg')}}">
                                        </div>
                                    </a>
                                </div>
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="col-md-12">
                                                    <img src="{{URL::to('public/img/servicos/cargas-excedentes.jpg')}}" class="img-responsive" alt="Transporte rodoviario">
                                                </div>
                                                <div class="col-md-12">
                                                    <br>
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12">
                                <div class="servicos-item">
                                    <a href="#" data-target="#transporte-rodoviario" data-toggle="modal">
                                        <div class="servicos-item-azul"></div>
                                        <div class="servicos-item-imagem">
                                            <img src="{{URL::to('public/img/servicos/transporte-rodoviario.jpg')}}">
                                ...
                                <div class="modal fade" id="transporte-rodoviario" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="col-md-3">
                                                    <img src="{{URL::to('public/img/servicos/transporte-rodoviario.jpg')}}" class="img-responsive" alt="Transporte rodoviario">
                                                </div>
                                                <div class="col-md-9">
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12">
                                <div class="servicos-item">
                                    <a href="#" data-target="#transporte-perigoso" data-toggle="modal">
                                        <div class="servicos-item-azul"></div>
                                        <div class="servicos-item-imagem">
                                            <img src="{{URL::to('public/img/servicos/transporte-de-produtos-perigosos.jpg')}}">
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12">
                                <div class="servicos-item">
                                    <a href="#" data-target="#transporte-multimodal" data-toggle="modal">
                                        <div class="servicos-item-azul"></div>
                                        <div class="servicos-item-imagem">
                                            <img src="{{URL::to('public/img/servicos/otm.jpg')}}">
                                ...
                                <div class="modal fade" id="transporte-multimodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="col-md-3">
                                                    <img src="{{URL::to('public/img/servicos/otm.jpg')}}" class="img-responsive" alt="Transporte rodoviario">
                                                </div>
                                                <div class="col-md-9">
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12">
                                <div class="servicos-item">
                                    <a href="#" data-target="#armazenagem-mercadorias" data-toggle="modal">
                                        <div class="servicos-item-azul"></div>
                                        <div class="servicos-item-imagem">
                                            <img src="{{URL::to('public/img/servicos/armazenagem-de-mercadorias.jpg')}}">
                                ...
                                <div class="modal fade" id="armazenagem-mercadorias" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="col-md-3">
                                                    <img src="{{URL::to('public/img/servicos/armazenagem-de-mercadorias.jpg')}}" class="img-responsive" alt="Transporte rodoviario">
                                                </div>
                                                <div class="col-md-9">
                                                    <br>
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12">
                                <div class="servicos-item">
                                    <a href="#" data-target="#locacao-equipamentos" data-toggle="modal">
                                        <div class="servicos-item-azul"></div>
                                        <div class="servicos-item-imagem">
                                            <img src="{{URL::to('public/img/servicos/locacao-de-equipamentos.jpg')}}">
                                ...
                                <div class="modal fade" id="locacao-equipamentos" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="col-md-3">
                                                    <img src="{{URL::to('public/img/servicos/locacao-de-equipamentos.jpg')}}" class="img-responsive" alt="Transporte rodoviario">
                                                </div>
                                                <div class="col-md-9">
                                                    <br>
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12">
                                <div class="servicos-item">
                                    <a href="#" data-target="#transporte-mudancas" data-toggle="modal">
                                        <div class="servicos-item-azul"></div>
                                        <div class="servicos-item-imagem">
                                            <img src="{{URL::to('public/img/servicos/transporte-de-mudancas.jpg')}}">
                                ...
                                <div class="modal fade" id="transporte-mudancas" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="col-md-3">
                                                    <img src="{{URL::to('public/img/servicos/transporte-de-mudancas.jpg')}}" class="img-responsive" alt="Transporte rodoviario">
                                                </div>
                                                <div class="col-md-9">
                                                    <br>
